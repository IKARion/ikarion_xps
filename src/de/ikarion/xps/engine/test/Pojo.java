...
public class Pojo {
    ...
    public static Class<?> generate(String className, Map<String, Class<?>> properties) throws NotFoundException, CannotCompileException {
        ...
        // cc.setSuperclass(resolveCtClass(SuperPojo.class));
        cc.addInterface(resolveCtClass(PojoImpl.class));
        cc.addInterface(resolveCtClass(Serializable.class));

        // CtConstructor defaultConstructor = CtNewConstructor.make("public " + cc.getSimpleName() + "() {}", cc);
    ...
    public static interface PojoImpl {
